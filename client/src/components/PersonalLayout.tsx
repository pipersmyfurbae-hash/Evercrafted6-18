...
export default function PersonalLayout({ children }: { children: React.ReactNode }) {
  ...
  return <><SkipLink /><div className="personal-surface min-h-screen lg:grid lg:grid-cols-[252px_1fr]">
    ...
    <main id="main-content" className="min-w-0 bg-[#262422] p-4 md:p-7 lg:p-10">{children}</main>
  </div></>;
}
